...
$content_help = "도움말";
$content_forum = "포럼";
$content_changelog = "변경 사항";
$content_title = "macOS 압축 프로그램";

// Download
$content_platform = "$version_replace 이상 버전이 필요합니다.";
...
$content_info_v2_text3 = "내가 원하는 것만<br />미리보고, 압축 해제하고, 공유하세요";
...
$content_defaultapp_text = 'Keka를 기본 압축 해제 앱으로 설정하려면 <a href="https://github.com/aonez/Keka/wiki/Default-application">도우미 앱이 필요합니다 <i class="far fa-question-circle"></i></a>.<br />도우미 앱을 다운로드하여 압축을 푼 뒤, 데스크톱으로 이동시켜 실행해 주세요.';

// Terms of use
$content_termsofuse_title = '이용약관';
$content_termsofuse_disclaimer = '저작권자와 기여자는 이 소프트웨어를 "있는 그대로의" 상태로 제공하며, 상품성 여부나 특정 목적에 대한 적합성에 관하여 묵시적 보증을 포함한 어떠한 형태의 보증도 명시적이나 묵시적으로 제공되지 않는다. 손해 가능성을 사전에 알고 있었다 하더라도, 저작권자나 기여자는 어떠한 경우에도 이 소프트웨어의 사용으로 인하여 발생한, 직접적이거나 간접적인 손해, 우발적이거나 결과적 손해, 특수하거나 일반적인 손해에 대하여, 그 발생의 원인이나 책임론, 계약이나 무과실책임이나 불법행위(과실 등을 포함)와 관계 없이 책임을 지지 않는다. 이러한 조건은 대체 재화나 용역의 구입 및 유용성이나 데이터, 이익의 손실, 그리고 영업 방해 등을 포함하나 이에 국한되지는 않는다.';
$content_termsofuse_inapp_title = '앱 내 구입';
$content_termsofuse_inapp = 'Keka App Store 버전에서는 앱 내 구입을 통해 <a href="https://www.keka.io/#lovekeka">PayPal/웹사이트 내 스폰서</a>처럼 프로젝트 개발을 독려하고 지원할 수 있습니다. 결제는 선택 사항이며 추가로 제공되는 기능은 없습니다.';

// Privacy Policy
$content_privacypolicy_title = '개인정보처리방침';
$content_privacypolicy_content = 'Keka는 사용자의 컴퓨터에서 어떤 데이터도 보내거나 저장하지 않습니다.';
$content_privacypolicy_MAS = 'MAS 버전에는 네트워크 기능이 일절 없습니다.';
$content_privacypolicy_WEB = 'WEB 버전은 업데이트 과정에서 Sparkle을 이용해 (비활성화 가능), 구성 요소가 인터넷에 연결할 수 있도록 합니다. 이는 새 버전을 확인하고 다운로드하는 용도로만 쓰입니다. 본 구성 요소는 어떤 정보도 보내거나 저장하지 않으며, 심지어 <a href="https://sparkle-project.org/documentation/system-profiling/">익명 시스템 프로필 데이터</a>조차 Keka 1.0.0 이전 일부 버전에서 설정이 켜진 적 있지만 절대 실제로 쓰이지는 않았습니다.';

// Main content of the page
$content_context_menu = "컨텍스트 메뉴";
